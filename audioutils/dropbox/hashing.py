...
def get_dropbox_hash_check(local_path, dbx_metadata):

    dbx_hash = dbx_metadata.content_hash
    local_hash = get_dropbox_hash(local_path)
...
# NOTE: NOT MY CODE, TAKEN FROM https://github.com/dropbox/dropbox-api-content-hasher
